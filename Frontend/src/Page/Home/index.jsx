            ...
            <SwiperSlide className="swiper-slide1">
              {video ? (
                <Box>
                  ...
                  >
                    <source
                      src={import.meta.env.VITE_BASE_URL + videoSlider[0]}
                    />
                  </video>
                  <Button
                    onClick={handleVideo}
            ...
            <SwiperSlide className="swiper-slide2">
              {videoTo ? (
                <Box>
                  ...
                  >
                    <source
                      src={import.meta.env.VITE_BASE_URL + videoSlider[1]}
                    />
                  </video>
                  <Button
            ...
            <SwiperSlide className="swiper-slide3">
              {videoTr ? (
                <Box>
                  ...
                  >
                    <source
                      src={import.meta.env.VITE_BASE_URL + videoSlider[2]}
                    />
                  </video>
                  <Button
            ...
            <SwiperSlide className="swiper-slide4">
              {videoFr ? (
                <Box>
                  ...
                  >
                    <source
                      src={import.meta.env.VITE_BASE_URL + videoSlider[3]}
                    />
                  </video>
                  <Button
                      ...
                      <Box>
                        <Avatar
                          src={
                            cards
                              ? url +
                                cards[0].attributes?.image?.data?.attributes
                                  ?.url
                              : []
                          }
                          sx={{
                      ...
                      <Box>
                        <Avatar
                          src={
                            cards
                              ? url +
                                cards[1].attributes?.image?.data?.attributes
                                  ?.url
                              : []
                          }
                          sx={{
                      ...
                      <Box>
                        <Avatar
                          src={
                            cards
                              ? url +
                                cards[2].attributes?.image?.data?.attributes
                                  ?.url
                              : []
                          }
                          sx={{
                      ...
                      <Box>
                        <Avatar
                          src={
                            cards
                              ? url +
                                cards[3].attributes?.image?.data?.attributes
                                  ?.url
                              : []
                          }
                          sx={{
                      ...
                      <Box>
                        <Avatar
                          src={
                            cards
                              ? url +
                                cards[4].attributes?.image?.data?.attributes
                                  ?.url
                              : []
                          }
                          sx={{
            ...
            >
              <SwiperSlide>
                <Grid
                  container
                  xs={12}
                  sx={{ justifyContent: "center", py: 18 }}
                >
